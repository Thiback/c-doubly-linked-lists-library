...
Test(add_dllist_head, single_call_empty_list,
...
Test(add_dllist_head, single_call_single_node,
.description="single call on a list with only one object")
{
    dllist_t mylist = dllist_create();
    ...
    cr_assert_eq(mylist.add_head(&mylist, "head"), 0);
    cr_assert_eq(mylist.len, 2);
    cr_assert_neq(mylist.head, mylist.tail);
    cr_assert_eq(strcmp(mylist.head->data, "head"), 0);
    cr_assert_eq(mylist.head->prev, NULL);
    cr_assert_eq(strcmp(mylist.tail->data, "tata"), 0);
    cr_assert_eq(mylist.tail->next, NULL);
    cr_assert_eq(mylist.tail->prev, mylist.head);
}

Test(add_dllist_head, three_node_list_creation,
.description="creation of a list of three nodes.")
{
    ...
    cr_assert_eq(mylist.add_head(&mylist, "tutu"), 0);
    ...
    cr_assert_eq(strcmp(mylist.head->data, "tutu"), 0);
    cr_assert_eq(mylist.head->prev, NULL);
    ...
    cr_assert_eq(strcmp(node_3->data, "tata"), 0);
    cr_assert_eq(node_3->prev, node_2);
    cr_assert_null(node_3->next);
}

Test(add_dllist_head, five_node_list_creation,
.description="creation of a list of three nodes.")
{
    dllist_t mylist = dllist_create();
    node_t *node_2;
    ...
    cr_assert_eq(mylist.add_head(&mylist, "titi"), 0);
    cr_assert_eq(mylist.add_head(&mylist, "tutu"), 0);
    cr_assert_eq(mylist.add_head(&mylist, "tete"), 0);
    ...
    //testing the head node
    cr_assert_eq(strcmp(mylist.head->data, "toto"), 0);
    cr_assert_eq(mylist.head->prev, NULL);
    cr_assert_not_null(mylist.head->next);

    //testing the second node
    node_2 = mylist.head->next;
    cr_assert_eq(strcmp(node_2->data, "tete"), 0);
    cr_assert_not_null(node_2->next);
    cr_assert_eq(node_2->prev, mylist.head);
    cr_assert_not_null(node_2->next);
    ...
    node_4 = node_3->next;
    cr_assert_eq(strcmp(node_4->data, "titi"), 0);
    cr_assert_eq(node_4->prev, node_3);
    cr_assert_not_null(node_4->next);

    //testing the last node
    node_5 = node_4->next;
    cr_assert_eq(strcmp(node_5->data, "tata"), 0);
